        ...
        <div class="row">
            ...
            >
                <div class="span3 product">
                     ...
                     <div>
                            <figure> <?
                                 <a href="${pageContext.servletContext.contextPath}/products?idproducts=${product.idproducts}"><img src="${pageContext.servletContext.contextPath}${product.imagePathes}" alt="${product.name}"></a>
                                 <div class="overlay">

                                  <a href="${pageContext.servletContext.contextPath}/products?idproducts=${product.idproducts}" class="link"></a>
                             </div>
                             </figure>
                        <div class="detail">
